...
| Coupon<br/>@/coupon/<id>@ | "Retrieve coupon":#api-coupon-show | - | "Update coupon":#api-coupon-update | "Archive coupon":#api-coupon-archive |
...
* @recurring@ Boolean. If true, the discount will be applied at signup and every renewal (for the number of renewals given by @coupon_duration_period_count@). Otherwise, discount will be applied only at signup.
* @coupon_duration_period_count@ Integer. Number of renewals the coupon is good for. Recurring should be set to true.  Setting @recurring@ to true and leaving this blank indicates that the coupon applies indefinitely.
...
Eg. URL: @https://<subdomain>.chargify.com/product_families/<product_family_id/coupons/<coupon_id>/validate.<format>@
...
<pre><code>[
  {
    ...
    "id":3,            // Product ID
    "revenue":"48.00", // Revenue from subscriptions that used coupon
    "signups":1,       // Number of signups that used coupon
    "savings":"12.00"  // Savings given by coupon
  },
  {
    "name":"Pro",
    "id":4,
